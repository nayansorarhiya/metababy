...
import { API, Games as vBList } from "../config";
            ...
            <Container>
                <Box sx={{
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} md={4} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: "space-between", pt: 2, pb: 3 }}>
                            ...
                            <Typography sx={{ mt: 3, fontSize: 14 }}>LAUNCHING ON BISWAP AT APRIL 13TH, 5PM UTC</Typography>
                            <Button variant="contained" color="secondary" size="large" sx={{
